...
const ROUTE = INVOICE_ROUTES.STAFF.FETCH_ALL.URL;
const KEY = INVOICE_ROUTES.STAFF.FETCH_ALL.KEY;
...
export default useStaffInvoices;

export const useStaffInvoicesTotal = ({
    startDate = startOfMonth(new Date()),
    endDate = endOfMonth(new Date()),
}: { startDate?: Date; endDate?: Date }) => {
    const res = useStaffInvoices({ startDate, endDate, select: (data: ApiResponse) => { return data } })
